...
<head>
	...
	<title>Admin | Blood Articles</title>
	<style>
...
<div class="page">
	<div class="topbar">
		<div class="title">
			...
			<div>
				...
				<div class="subtitle">Admin view of hospital-created articles</div>
			</div>
		</div>
		<div class="actions">
			<span class="btn btn-primary">View Only</span>
		</div>
	</div>
	...
	<div class="cards">
		@forelse ($articles as $article)
			<div class="article-card">
				...
				<div class="card-footer">
                    ...
                    <span class="badge badge-hospital">Approve</span>
                    </a>
                    <a href="{{ route("admin.articles.reject", $article->id) }}">
                    <span class="badge badge-hospital">Reject</span>
                    </a>
		...
		@empty
			<div class="empty">No articles found yet.</div>
		@endforelse
	</div>

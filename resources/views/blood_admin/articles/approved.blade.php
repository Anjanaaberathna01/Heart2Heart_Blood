...
<head>
    ...
    <title>Admin | Approved Articles</title>
    <style>
    ...
    <div class="topbar">
        <div class="title">
            ...
            <div>
                ...
                <div class="subtitle">Admin view of approved hospital articles</div>
            </div>
        </div>
        <div class="actions">
            <a class="btn btn-ghost" href="{{ route('admin.articles') }}">Pending</a>
            <a class="btn btn-ghost" href="{{ route('admin.articles.rejected') }}">Rejected</a>
        ...
        @forelse ($articles as $article)
            <div class="article-card">
                ...
                <div class="card-footer">
                    ...
                    <span class="badge badge-status">Approved</span>
                </div>
            </div>
        @empty
            <div class="empty">No approved articles found yet.</div>
        @endforelse
    </div>

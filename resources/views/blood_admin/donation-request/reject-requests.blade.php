...
<div class="container">
    ...
    <div class="page-header">
        <h1>❌ Rejected Donation Requests</h1>
    </div>
            ...
            <table>
                ...
                <tbody>
                    @foreach($donationRequests as $request)
                        <tr>
                            <td>{{ $request->rejected_at ? $request->rejected_at->format('M d, Y') : '—' }}</td>
                            ...
                            <td><span class="admin-notes">{{ $request->admin_notes ?? 'No notes' }}</span></td>
